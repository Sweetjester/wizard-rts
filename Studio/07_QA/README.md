...
This suite is also the mechanically-checkable half of [06_Production's Definition of Done for unattended work](../06_Production/Unattended_Work_Definition_of_Done.md) — any code change delivered with less active supervision leans on these tests actually passing, not on self-reported confidence.
