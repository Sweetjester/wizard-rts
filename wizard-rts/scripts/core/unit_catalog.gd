...
const DEFINITIONS := {
	...
	&"terrible_thing": {
		...
		"role": "Cheap swarm unit. Weak alone, dangerous in packs.",
		"passives": ["Friendly-fire detonation", "Pack grappler"],
	...
	&"awful_thing": {
		...
		"population": 1,
		"cost_bio": 0,
		"role": "Evolved Terrible Thing with stronger melee and better grapple pressure.",
		"passives": ["Friendly-fire detonation", "Pack grappler"],
		"actives": ["Charge", "Grapple"],
		"grapple_power": 2,
		"grapple_seconds": 2.8,
		...
		"death_explosion_damage": 24,
		"death_explosion_radius": 104.0,
		"friendly_fire_explodes": true,
	},
	&"horror": {
		"display_name": "Horror",
	...
	&"apex_predator": {
		...
		"population": 2,
		"cost_bio": 0,
		"role": "Evolved Apex. Becomes a heavy front-line predator.",
		"passives": ["Combat healing"],
		"actives": ["Eat ally"],
	},
	&"spawner": {
	...
	&"barracks": {
		...
		"footprint": Vector2i(3, 3),
		"production": [&"terrible_thing", &"horror", &"apex", &"spawner"],
	},
	&"terrible_vault": {
